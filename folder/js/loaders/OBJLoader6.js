...
THREE.OBJLoader.prototype = {
	...
	parse: function ( text ) {
		...
		function addVertex( a, b, c ) {
			...
			object.geometry.barycentric.push(
				parseFloat(1.), parseFloat(0.), parseFloat(0.),
				parseFloat(0.), parseFloat(1.), parseFloat(0.),
				parseFloat(0.), parseFloat(0.), parseFloat(1.)
			);
		...
		for ( var i = 0, l = objects.length; i < l; i ++ ) {
			...
			buffergeometry.addAttribute( 'barycentric', new THREE.BufferAttribute( new Float32Array( geometry.barycentric ), 3 ) );
